...
<html lang="en">
	...
	<head><base href="../../../../">
		<meta charset="utf-8" />
		<title>Login Pengaduan PDAM</title>
		...
		<link href="{{asset('assets1/css/pages/login/classic/login-3.css')}}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-3 login-signin-on d-flex flex-row-fluid" id="kt_login">
				<div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url({{asset('assets1/media/bg/bg-10.jpg')}});">
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						<!--begin::Login Header-->
						<div class="d-flex flex-center mb-15">
							<a href="#">
								<img src="{{asset('assets1/media/logos/logo-pdam.png')}}" class="max-h-200px" alt=""/>
							</a>
						</div>
						<!--end::Login Header-->
						...
						<div class="login-signin">
							<div class="mb-20">
								<h3>PENGADUAN PELANGGAN PDAM TIRTA LESTARI TUBAN</h3><br>
								<p class="opacity-60 font-weight-bold">Masukkan akun Anda :</p>
							</div>
							...
							<form class="form" action="authenticate" method="POST">
								...
								<div class="form-group d-flex flex-wrap justify-content-between align-items-center px-8">
									...
									<a href="/forgotpw" id="kt_login_forgot" class="text-white font-weight-bold">Lupa Password ? Klik Disini</a>
								</div>
							...
							<div class="mt-10">
								<span class="opacity-70 mr-4">Anda belum mempunyai Akun?</span>
								<a href="/register" class="text-white font-weight-bold">Daftar</a>
							</div>
						</div>
						<!--end::Login Sign in form-->
						<div class="kt_login_signin_submit">
                        <a href="/"></a>    
                        </div> 
