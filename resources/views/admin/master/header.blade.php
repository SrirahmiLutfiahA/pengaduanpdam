...
<head>
    ...
    <link href="{{ asset('assets1/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{ asset('assets1/css/themes/layout/header/base/dark.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets1/css/themes/layout/header/menu/dark.css') }}" rel="stylesheet" type="text/css" />
