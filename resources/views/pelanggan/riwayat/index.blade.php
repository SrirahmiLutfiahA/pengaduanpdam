                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <?php echo svg() ?>
                            <h2>Laporan Pengaduan Berhasil</h2>
                            <p>Terima kasih telah mengirimkan laporan terkait pengaduan, <br>permintaan anda akan segera kami tindaklanjuti.</p>

                            <a href="{{ url('riwayat') }}">Lihat Riwayat Pengaduan</a>
                        </div>
                    </div>
                        ...
                        <div class="col-md-10">
                            <div class="card card-body">
                                ...
                                <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable" width="100%">
                                    <thead>
                                        <tr>
                                            <th title="" width="5%">No</th>
                                            <th title="Field #2">Tanggal Pengaduan</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td width="5%">{{ $nomor }}</td>
                                            <td>{{ date('d F Y H.i A', strtotime($pd->created_at)) }}</td>
                                            <td><label for="" class="">{{ $pd->namakategori }}</label></td>
                                            <td>{{ $pd->keterangan }}</td>
                                            <td>
                                                <a href="{{ url('riwayat/detail/'. $pd->id) }}" class="btn btn-sm btn-primary">Lihat Detail</a>
                                            </td>
                                        </tr>
