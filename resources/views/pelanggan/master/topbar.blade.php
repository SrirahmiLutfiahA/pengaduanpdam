        ...
        <div class="topbar">
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-clean btn-lg mr-1" id="kt_quick_panel_toggle">
                    <span class="svg-icon svg-icon-danger svg-icon-xl svg-icon-primary">
                        <!--begin::Svg Icon | path:assets1/media/svg/icons/Layout/Layout-4-blocks.svg-->
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                    ...
                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">Users</span>
